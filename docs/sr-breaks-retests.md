...
8. **Colors** are the original constants: Pine `color.green` `#4caf50` and `color.red` `#f44336` borders, `#20ca26`/`#e92929` diamonds, `#7e1e1e`/`#2b6d2d` break-label backgrounds, foreground text from the chart theme.
